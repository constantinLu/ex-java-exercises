...
public class _45LongestSubStringWithoutRepeatingChars {

    public static void main(String[] args) {

/*Write a java program or function to find the longest substring without repeating characters in a given string.
For example, if “javaconceptoftheday” is the input string, then the longest substring without repeating or duplicate characters
